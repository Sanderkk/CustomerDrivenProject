           ...
           public async Task<MetadataType> GetMetadataBySensorID(string queryString)
        {
            ...
            while (dataReader.Read())
            {
                ...
                {   
                    ...
                    Company = dataReader["company_id"]==DBNull.Value ? (string?)null :dataReader.GetFieldValue<string>(dataReader.GetOrdinal("company")),
                    ServicePartner = dataReader["service_partner_id"]==DBNull.Value ? (string?)null :dataReader.GetFieldValue<string>(dataReader.GetOrdinal("service_partner_id")),
                    Department = dataReader["department_id"]==DBNull.Value ? (string?)null :dataReader.GetFieldValue<string>(dataReader.GetOrdinal("department_id")),
